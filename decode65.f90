...
! Compute spectra of the channel symbols
  f0=1270.46 + dfx
  call spec2d65(dat,npts,nsym,flip,istart,f0,ftrack,nafc,mode65,nfast,s2)
  ...
  qual=0.
  if(ndepth.ge.1) call deep65(s3,mode65,neme,flip,mycall,hiscall,hisgrid,  &
       deepmsg,qual)
