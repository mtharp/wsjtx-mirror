...
:samples_windows: http://physics.princeton.edu/pulsar/K1JT/WSJT_Samples.zip[ Windows ]
:samples_linux: http://physics.princeton.edu/pulsar/K1JT/WSJT_Samples.tgz[ Linux ]
:call3: http://www.dl8ebw.de/DATABASE/database.html[ DL8EBW ]
...
[[PROTOCOLS]]
== Specifications of WSJT Protocols
