...
on-screen, they may contain as many as 18 characters.
...
free-text nessages, as the program might then try to interpret your
...
conversations or rag-chewing.  [[COMP-CALL]] === Compound Callsigns
