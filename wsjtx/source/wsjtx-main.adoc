...
Open the *Configuration* window by selecting *Settings* from the
*File* menu, or by typing *F2*.  The following sections describe setup
optiions available on each of six tabs selectable near the top of the
window.
