...
f2=Frame(g1.interior(),width=100,height=15)
rightAudio=IntVar()
Label(f2,text='Audio input:  ').pack(side=LEFT)
rb7=Radiobutton(f2,text='L ',value=0,variable=rightAudio)
rb8=Radiobutton(f2,text='R  ',value=1,variable=rightAudio)
rb7.pack(anchor=W,side=LEFT,padx=2,pady=2)
rb8.pack(anchor=W,side=LEFT,padx=2,pady=2)
f2.pack()

g2=Pmw.Group(root,tag_text="Templates (JTMS, FSK441, FSK315 ISCAT, JT6M, JT4)")
