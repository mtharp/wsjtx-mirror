...
Query and print PortAudio HostAPIs, Devices, and their support rates.

Credit: https://raw.githubusercontent.com/jleb/pyaudio/master/test/system_info.py

Copied directly from Github user: jleb, all credit to the user.
