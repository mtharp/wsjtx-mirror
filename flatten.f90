...
! Examines the 2-d spectrum s2(nbins,jz) and makes a reference spectrum
! from the jz/2 spectra below the 50th percentile in total power.  Uses
! reference spectrum (with birdies removed) to flatten the passband.
