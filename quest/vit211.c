...
#ifdef V211
#define	K 11			/* Constraint length */
#define N 2			/* Number of symbols per data bit */
#define Polys	Poly211		/* Select polynomials here */
#endif

/* Rate 1/2 codes */
unsigned int Poly211[] = {02335,03661};	          /* k = 11  */
...
int *nn)                        // N
{
  ...
  enc211(symbols,data,nbytes,0,0); // Do the encoding
...
/* Convolutionally encode data into binary symbols */
  enc211(unsigned char symbols[], unsigned char data[],
...
long *Metric              /* Final path metric (bigger is better) */
  ...
  long metric;
  vit211(&metric,ddec,symbols,*Nbits,mettab,0,0);
  *Metric=metric;
}
