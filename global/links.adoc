...
:gnu_gpl: http://www.gnu.org/licenses/gpl-3.0.txt[GNU GPL]
...
:wsjt_yahoo_group: https://groups.yahoo.com/neo/groups/wsjtgroup/info[WSJTgroup]
...
:bill_somerville: mailto:g4wjs@classdesign.com[G4WJS]
