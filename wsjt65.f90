...
! Write decoded msg unless this is an "Exclude" request:
  ...
  if(nsave.ge.1) call avemsg65(1,mode65,ndepth,avemsg1,nused1,nq1,nq2,  &
       neme,mycall,hiscall,hisgrid,qual1,ns1,ncount1)
  if(nsave.ge.1) call avemsg65(2,mode65,ndepth,avemsg2,nused2,nq1,nq2,  &
...
1023 format(a6,i3,i4,'/',i3,18x,a19,i8,i4)
     if(lcum .and. (avemsg1.ne.'                  ')) write(21,1011) ave1
     ns10=ns1
     call cs_unlock
  endif
