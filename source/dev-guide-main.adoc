...
////
Communications should be moved to a gloabl file to prevent rework / repeat in the
various guides.
include::../global/comminication.adoc
////

== Communication

The following are established communication channels with the WSJT group.
