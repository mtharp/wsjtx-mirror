...
svn export --force svn://svn.code.sf.net/p/wsjt/wsjt/branches/doc/dev-guide/source/wsjtx-compile.sh
...
[[MANUAL]]
.Manual Entry
* For manual entry, start at +*BUILD_DIR=~/wsjt-env/wsjtx-build*+ and
