...
==== Import Script
*Copy & Paste* the scipt directly into a terminal window.

IMPORTANT: You can perform the steps manually if desired. The script
simply automates the manual steps. When importing the script, you will
see two errors, this is expected as the repository has yet to be
checked out.

* Tested on Ubuntu 12.04 64-bit {amp} 14.04 64-bit
* Copy from pass:[cat > ... to last EOL]
