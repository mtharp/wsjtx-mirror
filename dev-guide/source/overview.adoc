...
The purpose of the {page} is to walk through the various elements of building
...
specific to **_WSJT_** applications them self, such as jt9sim, and command line
...
devlopers. Rather, the scripts should be considered an aid to troubleshooting
as the average user will not be changing the default build constructs. Thus 
providing the experienced developer with a know set of variables used to build
...
=== The Command Line
When using *JTSDK*, all work is performed from the ( _Command Line_ ), *DOS Console* 
...
****
In both *JTSDK-Win32* and *JTSDK-Nix*, there are literally hundreds of tools
...
=== Special Terms
The following is a short list of special terms used throughout this guide:
