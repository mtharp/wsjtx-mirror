...
:jtsdk-nix: http://sourceforge.net/projects/jtsdk/files/linux/2.0.0/jtsdk-nix-2.0.16.tar.gz/download[JTSDK-Nix Download]
...
:projsummary: http://sourceforge.net/projects/wsjt/[WSJT on Sourceforge]
:pskreporter: http://pskreporter.info/pskmap.html[PSK Reporter]
:readmepkglist: http://sourceforge.net/p/jtsdk/jtsdk/HEAD/tree/jtsdk-nix/trunk/README.pkg-lists[README.pkg-list]
...
:wsjt-yahoo-group: https://groups.yahoo.com/neo/groups/wsjtgroup/info[WSJT Group Email List]
...
:launchpad_jtsdk: https://launchpad.net/~ki7mt/+archive/ubuntu/jtsdk[Launchpad]
:sourceforge_linux_tarball: https://sourceforge.net/projects/jtsdk/files/linux/2.0.0/[SourceForge]
...
:jtsdk-installer: http://sourceforge.net/projects/jtsdk/files/win32/2.0.0/JTSDK-2.0.0-win32.exe/download[Download]
:jtsdk-nix-2-0-16: http://sourceforge.net/projects/jtsdk/files/linux/2.0.0/jtsdk-nix-2.0.16.tar.gz/download[Download]
:jtsdk-update1: http://sourceforge.net/projects/jtsdk/files/win32/2.0.0/JTSDK-2.0.0-u1-win32.exe/download[Download]
:jtsdk-update2: http://sourceforge.net/projects/jtsdk/files/win32/2.0.0/JTSDK-2.0.0-u2-win32.exe/download[Download]
:jtsdk-update3: http://sourceforge.net/projects/jtsdk/files/win32/2.0.0/JTSDK-2.0.0-u3-win32.exe/download[Download]
:jtsdk-omnirig: http://sourceforge.net/projects/jtsdk/files/win32/2.0.0/base/contrib/OmniRig.zip/download[Download]
...
:jtsdk-vcredist-2010: http://sourceforge.net/projects/jtsdk/files/win32/2.0.0/base/contrib/vcredist_x86.exe/download[Download]
:jtsdk-vcredist-2013: http://sourceforge.net/projects/jtsdk/files/win32/2.0.0/base/contrib/vcredist_msvc2013_x86.exe/download[Download]
...
// MAIL-TO links
:alex-efros: mailto:powerman@powerman.name[Alex Efros]
:bill-somerville: mailto:g4wjs -at- c l a s s d e s i g n -dot- com[G4WJS]
:dev-mail-list: http://sourceforge.net/mailarchive/forum.php?forum_name=wsjt-devel[WSJT Developers Email List]
:dev-mail-svn: https://sourceforge.net/auth/subscriptions/[WSJT SVN Archives]
:devmail: mailto:wsjt-devel@lists.sourceforge.net[wsjt-devel]
:devmail1: mailto:wsjt-devel@lists.sourceforge.net[Post Message]
:greg-beam: mailto:ki7mt@yahoo.com[KI7MT]
:joe-taylor: mailto:joe@princeton.edu[K1JT]
:stuart-rackman: mailto:srackham@gmail.com[Stuart Rackham]
